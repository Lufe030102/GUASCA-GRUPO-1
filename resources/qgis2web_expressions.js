...
function exp_3101_6rule0_eval_expression(context) {
    // TIPO_VIA = 1

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('TIPO_VIA')  == 1);
    } else {
        return (feature.get('TIPO_VIA')  == 1);
    }
}
...
function exp_3101_6rule1_eval_expression(context) {
    // TIPO_VIA = 5

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('TIPO_VIA')  == 5);
    } else {
        return (feature.get('TIPO_VIA')  == 5);
    }
}
...
function exp_3101_6rule2_eval_expression(context) {
    // TIPO_VIA = 6

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('TIPO_VIA')  == 6);
    } else {
        return (feature.get('TIPO_VIA')  == 6);
    }
}
...
function exp_3101_6rule3_eval_expression(context) {
    // TIPO_VIA = 7

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('TIPO_VIA')  == 7);
    } else {
        return (feature.get('TIPO_VIA')  == 7);
    }
}
...
function exp_3101_6rule4_eval_expression(context) {
    // TIPO_VIA = 2

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('TIPO_VIA')  == 2);
    } else {
        return (feature.get('TIPO_VIA')  == 2);
    }
}
...
function exp_3101_6rule5_eval_expression(context) {
    // TIPO_VIA = 3

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('TIPO_VIA')  == 3);
    } else {
        return (feature.get('TIPO_VIA')  == 3);
    }
}
...
function exp_3101_6rule6_eval_expression(context) {
    // TIPO_VIA = 4

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('TIPO_VIA')  == 4);
    } else {
        return (feature.get('TIPO_VIA')  == 4);
    }
}